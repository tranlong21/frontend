...
// Danh sách ảnh album khớp chính xác với file có dấu gạch ngang trong thư mục public/img/
const WEDDING_ALBUM: AlbumImage[] = [
  { id: 2, url: '/img/optimized/ngay-cuoi_2.jpg', thumb: '/img/optimized/ngay-cuoi_2.jpg' },
  { id: 3, url: '/img/optimized/ngay-cuoi_3.jpg', thumb: '/img/optimized/ngay-cuoi_3.jpg' },
  { id: 4, url: '/img/optimized/ngay-cuoi_4.jpg', thumb: '/img/optimized/ngay-cuoi_4.jpg' },
  { id: 5, url: '/img/optimized/ngay-cuoi_5.jpg', thumb: '/img/optimized/ngay-cuoi_5.jpg' },
  { id: 6, url: '/img/optimized/ngay-cuoi_6.jpg', thumb: '/img/optimized/ngay-cuoi_6.jpg' },
  { id: 7, url: '/img/optimized/ngay-cuoi_7.jpg', thumb: '/img/optimized/ngay-cuoi_7.jpg' },
  { id: 8, url: '/img/optimized/ngay-cuoi_8.jpg', thumb: '/img/optimized/ngay-cuoi_8.jpg' },
  { id: 9, url: '/img/optimized/ngay-cuoi_9.jpg', thumb: '/img/optimized/ngay-cuoi_9.jpg' },
  { id: 10, url: '/img/optimized/ngay-cuoi_10.jpg', thumb: '/img/optimized/ngay-cuoi_10.jpg' },
  { id: 11, url: '/img/optimized/ngay-cuoi_11.jpg', thumb: '/img/optimized/ngay-cuoi_11.jpg' },
  { id: 12, url: '/img/optimized/ngay-cuoi_12.jpg', thumb: '/img/optimized/ngay-cuoi_12.jpg' },
  { id: 13, url: '/img/optimized/ngay-cuoi_13.jpg', thumb: '/img/optimized/ngay-cuoi_13.jpg' },
  { id: 14, url: '/img/optimized/ngay-cuoi_14.jpg', thumb: '/img/optimized/ngay-cuoi_14.jpg' },
  { id: 15, url: '/img/optimized/ngay-cuoi_15.jpg', thumb: '/img/optimized/ngay-cuoi_15.jpg' },
  { id: 16, url: '/img/optimized/ngay-cuoi_16.jpg', thumb: '/img/optimized/ngay-cuoi_16.jpg' },
];
...
const App: React.FC = () => {
  ...
  const handleOpenInvitation = () => {
    ...
    setTimeout(() => {
      setIsOpen(true);
      // Phát nhạc nền từ thư mục local /music/nhac-nen.mp3
  ...
  return (
    <div className={`min-h-screen bg-[#8b2b2b] selection:bg-rose-200 ${(showGiftModal || galleryIndex !== null) ? 'overflow-hidden' : ''} font-sans transition-colors duration-500`}>
      <audio ref={openSoundRef} src="https://assets.mixkit.co/active_storage/sfx/2571/2571-preview.mp3" preload="auto" />

      {/* ĐƯỜNG DẪN NHẠC NỀN CHUẨN TRONG THƯ MỤC /music */}
      <audio ref={bgMusicRef} src="/music/nhac-nen.mp3" loop preload="auto" />
      ...
      {(isOpen || isOpening) && (
        <div className="fixed bottom-6 right-6 sm:bottom-10 sm:right-10 z-[150]">
          ...
          >
            {!isMuted && <div className="absolute inset-0 border-2 border-white/20 rounded-full animate-spin-slow pointer-events-none"></div>}
            <span className={`text-xl sm:text-2xl z-10 ${!isMuted ? 'animate-pulse' : ''}`}>{isMuted ? '🔇' : '🎵'}</span>
          </button>
        </div>
      )}
          ...
          <div className="max-w-screen-md mx-auto bg-[#fdf6e3] shadow-2xl relative overflow-hidden min-h-screen">
            ...
            <div className="bg-[#f5ead5] py-20 px-6 sm:px-12 text-center border-y border-[#d4af37]/20 relative">
              <div className="max-w-lg mx-auto">
                <p className="uppercase text-[11px] sm:text-xs text-[#8b2b2b] font-bold tracking-[0.3em] mb-4">Lễ Thành Hôn được cử hành tại tư gia</p>
                <p className="text-2xl sm:text-3xl font-serif font-bold text-[#8b2b2b] mb-3">Đội 4 Nam Hải, xã Nghĩa Lâm, tỉnh Ninh Bình</p>
                <p className="uppercase text-[10px] text-[#8b2b2b]/50 tracking-[0.2em] mb-8">Vào lúc</p>
                <p className="text-7xl sm:text-8xl font-serif font-bold text-[#8b2b2b] mb-10 tracking-tighter">10:00</p>
                ...
                <p className="text-base sm:text-lg font-serif text-[#8b2b2b]/60 italic font-medium mb-8">(Tức ngày 12/01 Bính Ngọ)</p>
            ...
            <div className="py-20 px-6 sm:px-10 bg-[#f5ead5]/30">
              <div className="text-center mb-10">
                <h3 className="text-3xl sm:text-4xl font-serif font-bold text-[#8b2b2b] italic">Album Ảnh Cưới</h3>
              </div>
              <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-5xl mx-auto">
                {WEDDING_ALBUM.slice(0, 4).map((img, idx) => (
                  ...
                  >
                    <img src={img.thumb} alt="Wedding Album" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy" />
            ...
            <div className="bg-[#ece0cc] py-24 px-6 text-center">
              <h3 className="text-2xl sm:text-3xl font-serif font-bold text-[#8b2b2b] mb-8 italic">Địa điểm Tiệc cưới:</h3>
              <div className="bg-white p-8 sm:p-12 rounded-[2.5rem] border border-[#d4af37]/20 shadow-2xl inline-block w-full max-w-2xl transform transition hover:-translate-y-1">
                ...
                <p className="text-sm sm:text-lg text-gray-500 mb-10 leading-relaxed font-medium">Đội 4 Nam Hải, xã Nghĩa Lâm, tỉnh Ninh Bình</p>
                <button
            ...
            <div className="bg-[#8b2b2b] py-20 text-center border-t-8 border-[#d4af37]">
              <p className="text-white text-4xl sm:text-5xl font-serif mb-6 italic tracking-widest uppercase">Thịnh & Ngọc</p>
              <div className="h-[1px] w-24 bg-white/20 mx-auto mb-6"></div>
              <p className="text-white/30 text-[11px] tracking-[0.6em] uppercase font-bold">Lễ Thành Hôn 01-02-2026</p>
            </div>
          </div>
        </div>
      )}
      ...
      {showGiftModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-[#8b2b2b]/90 backdrop-blur-md" onClick={() => setShowGiftModal(false)}></div>
          <div className="relative w-full max-w-2xl bg-[#fdf6e3] rounded-3xl shadow-2xl overflow-hidden animate-zoom-in border border-[#d4af37]/20">
            <div className="bg-[#8b2b2b] py-6 text-center relative">
              <h3 className="text-2xl sm:text-3xl font-serif italic text-white tracking-widest">Hộp Mừng Cưới</h3>
              <button onClick={() => setShowGiftModal(false)} className="absolute top-1/2 -translate-y-1/2 right-6 text-white text-3xl opacity-60 hover:opacity-100 transition-opacity">✕</button>
            </div>
            ...
            <div className="p-8 sm:p-12">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                <div className="text-center">
                  ...
                  <div className="w-48 h-48 mx-auto bg-white p-3 rounded-2xl mb-4 shadow-xl border border-stone-100">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=VietinBank-106876543440-TranVanThinh" alt="QR Groom" className="w-full h-full rounded-xl" />
                  </div>
                ...
                <div className="text-center">
                  ...
                  <div className="w-48 h-48 mx-auto bg-white p-3 rounded-2xl mb-4 shadow-xl border border-stone-100">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=VCB-0961000038320-TranThiNgoc" alt="QR Bride" className="w-full h-full rounded-xl" />
                  </div>
              ...
              <p className="mt-10 text-center text-stone-500 text-sm italic">Cảm ơn bạn đã đồng hành cùng chúng mình trong ngày trọng đại!</p>
            </div>
          </div>
        </div>
      )}
